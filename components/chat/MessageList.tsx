...
export function MessageList({
  ...
  useEffect(() => {
    ...
    const hasEncrypted = sorted.some((m) => isEncryptedContent(m.content));
    if (hasEncrypted) {
      window.dispatchEvent(new Event("require-private-key"));
    }
  }, [privateKey, messageIds]);
  ...
  return (
    <div className="flex-1 overflow-y-auto custom-scrollbar min-h-0 bg-transparent mt-4">
