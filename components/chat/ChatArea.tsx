...
export function ChatArea({ selectedConversationId }: ChatAreaProps) {
  ...
  if (!selectedConversationId) {
    return (
      <section className="flex-1 flex flex-col bg-chat-bg min-w-0 items-center justify-center text-foreground">
        <p className="text-sm">
  ...
  return (
    <section className="flex-1 flex flex-col min-w-0 bg-chat-bg">
      <MessageList
        messages={messages}
